...
class HomeController extends ChangeNotifier {
  ...
  void clearFoodSelectionIfUnavailable(
    int Function(String foodId) quantityFor,
  ) {
  ...
  Future<FoodFeedResult> handleSelectedFoodTap() {
    ...
    _foodTapTail = _foodTapTail.then((_) async {
      try {
        ...
        final selectionStillCurrent = _isFoodSelectionCurrent(foodId, revision);
  ...
  Future<HomeActionResult> tryStartPlaying({
    ...
    return switch (result) {
      ...
      CareActionResult.notEnoughEnergy => const HomeActionResult.rejected(
        HomeNotice.needsRest,
      ),
